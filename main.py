...
def telegram():
    ...
    if (skip):
        ...
        client.send_message(BOT, emoji.emojize("❤️"))
...
def vkontakte():
    ...
    try:
        ...
        if (skip):
            ...
            input(f"{Fore.CYAN}Для пропуска анкеты нажмите ENTER")
            vk.method("messages.send", {"peer_id": -91050183, "message": "1", "random_id": get_random_id(),"captcha_sid":cap_sid, "captcha_key":cap_code})
